                              ...
                              {filteredOrders.map((order: any, index: number) => {
                                ...
                                return (
                                  <tr key={order.id} className="group transition-colors hover:bg-[#f8fafc]">
                                    ...
                                    <td className="px-5 py-4 text-center">
                                        {(order.shippingMethod?.nama === 'ambil_apotek' || order.shipping_method === 'ambil_apotek' || order.shipping_method === 'ambil_sendiri' || order.shippingMethod?.nama_metode === 'ambil_sendiri' || order.shippingMethod?.nama === 'Ambil di Apotek') ? (
